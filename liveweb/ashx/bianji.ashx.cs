...
namespace liveweb
{
    ...
    /// bianji 的摘要说明
    /// </summary>
    public class bianji : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string paperid = context.Request.Params["paperid"].ToString();
            //根据参数调用不同的方法
            SqlConnection conn = new SqlConnection();
            conn.ConnectionString = "Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=liveweb;Data Source=.\\SQLEXPRESS";
            conn.Open();
          
            string sql = "select * from " + meth + " where userid=" + userid + "and paperid="+paperid+"";
