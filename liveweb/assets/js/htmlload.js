...
function sidebarload()//此js为页面首次加载时的js，直接在此函数内写入即可
{
    ...
    function jumptopreview(id) {
        window.location.href = "/pdfview.html?id="+id+"";
    }
    //论文加载
    $.ajax(
            {
